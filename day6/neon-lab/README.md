...
Building neon-lab requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building neon-lab, you can explore its exports at the Node console:
